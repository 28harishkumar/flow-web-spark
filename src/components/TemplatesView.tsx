...
const TemplatesView: React.FC = () => {
  ...
  const renderTemplatePreview = (template: any) => {
    ...
    const themeClass =
      themes[template.content.theme as keyof typeof themes] || themes.light;

    return (
      <div
        className={`template-preview ${themeClass} rounded-lg p-6 max-w-md mx-auto shadow-lg`}
      >
    ...
    <div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-4xl w-full">
          <DialogHeader>
            <DialogTitle>
              {activeTemplate?.id.startsWith("t-")
                ? "Create Template"
                : "Edit Template"}
            </DialogTitle>
            <DialogDescription>
              Design your message template. This will be shown to users when
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setActiveTemplate({ ...activeTemplate, type: value })
                  }
                >
                  <SelectTrigger>
